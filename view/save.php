<div class="postbox rw-body">
    ...
    <div class="inside update-nag" style="margin: 0; border: 0;">
        <p class="submit" style="margin: 0; padding: 10px;">
            ...
            <input type="submit" name="Submit" style="font-size: 16px; font-size: 16px !important; padding: 5px 10px 5px 10px;" class="button-primary" value="<?php esc_attr_e('Save Changes') ?>" />
        </p>
    </div>
</div>
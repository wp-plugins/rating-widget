        ...
        <div class="postbox rw-body">
            ...
            <div class="inside rw-ui-content-container rw-no-radius">
                <div class="rw-ui-img-radio rw-ui-hor<?php if ($is_accumulated) echo ' rw-selected';?>"<?php if (!$bbpress_support) echo 'onclick="alert(\'User Reputational ratings are only supported in the Premium package.\'); return false;"';?>>
                    <i class="rw-ui-sprite"></i> <input type="radio" name="rw_accumulated_user_rating" value="true" <?php if ($is_accumulated) echo ' checked="checked"';?>> <span><?php _e('Reputational (Premium Feature) - average of all user\'s rated elements (forum posts, activites, blog posts, etc.)', WP_RW__ID) ?></span>
                </div>

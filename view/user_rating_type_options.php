    ...
    <div class="has-sidebar-content">
        <div class="postbox rw-body">
            ...
            <div class="inside rw-ui-content-container rw-no-radius">
                <div class="rw-ui-img-radio rw-ui-hor<?php if ($is_accumulated) echo ' rw-selected';?>"<?php if (!$bbpress_support) echo 'onclick="alert(\'User Reputational ratings are only supported in the Professional plan.\'); return false;"';?>>

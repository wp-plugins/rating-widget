<div class="wrap">
    ...
    <p style="line-height: 18px;">
        Before you start using the Rating-Widget plugin it's important for you to understand that the Rating-Widget project is a self-hosted voting control for your website. It is based on dynamic HTML & Javascript and was intestinally developed as plug & play widget for easy installation (without the need of setting any DB or backend support).
        ...
        Please read our full <a href="<?php echo WP_RW__ADDRESS;?>/terms-of-use/">Terms of Use</a> and <a href="<?php echo WP_RW__ADDRESS;?>/privacy/">Privacy Policy</a> for more details before you start using the plugin.<br />
    </p>
    ...
    <form action="" method="post">
        ...
        <p class="submit">
            <label><input type="checkbox" name="rw_service_terms" value="1" /> I've read and I accept the <a href="<?php echo WP_RW__ADDRESS;?>/terms-of-use/">Terms of Use</a> and <a href="<?php echo WP_RW__ADDRESS;?>/privacy/">Privacy Policy</a> of the <a href="<?php echo WP_RW__ADDRESS;?>">Rating-Widget</a> service.</label>
            <br />
